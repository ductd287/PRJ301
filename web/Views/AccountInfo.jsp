        ...
        <div class="wrapper">
            ...
            <div id="content">
                ...
                <div class="user-info">
                    ...
                    <!-- Displaying Username and Phone as text, rest as editable fields -->
                    ...
                    <!-- Change Password -->
                    <form id="passwordChangeForm" action="AccountInfoServlet" method="post">
                        <div class="form-group">
                    ...
                    <!-- Activate Button - Show only if the user is not active -->
                    <c:if test="${!user.active}">
                        <form action="AccountInfoServlet" method="POST" class="activate-form">

                            <!-- Input for new phone number -->
                            <input type="text" name="phone" placeholder="Phone number to activate" required class="phone-input"/>
                ...
                <script>
                    document.getElementById("passwordChangeForm").onsubmit = function () {
